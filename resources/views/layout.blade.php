                        ...
                        <form class="d-flex">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ url('dangxuat') }}">Đăng Xuất</a></li>
                        ...
                        <form class="d-flex">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ url('dangnhap') }}">Đăng Nhập</a></li>
                                        {{-- <li><a class="dropdown-item" href="#">Quên Mật Khẩu</a></li> --}}
                                        <li><a class="dropdown-item" href="{{ url('dangky') }}">Đăng Ký Thành Viên</a>
                                        </li>
                                    </ul>
                                </li>
                        <li class="nav-item"><a class="nav-link active" href="/hiengiohang"><i class="fa-solid fa-cart-plus"></i> Giỏ hàng</a></li>
