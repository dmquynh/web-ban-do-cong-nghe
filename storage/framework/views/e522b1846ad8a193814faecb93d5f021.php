...
<div id="spmoi" class="my-3">
    <h2 class="btn rounded-0 fs-5 mb-0 rounded-top-2 text-white mt-3" style="background-color: #0f57c3;">Sản phẩm mới</h2>
    <div class="card mb-3 border-2" style="background-color: #0f57c3;"></div>
    <div class="row row-cols-1 row-cols-md-4 g-4">
        <?php $__currentLoopData = $spmoi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col">
...
</div><?php /**PATH D:\xampp\htdocs\PHP3\ASM1 - Copy\resources\views/spmoi.blade.php ENDPATH**/ ?>